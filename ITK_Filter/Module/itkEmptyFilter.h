 ...
 *
 *=========================================================================*/
#ifndef itkEmptyFilter_h
#define itkEmptyFilter_h
...
public:
  ...
  itkTypeMacro(EmptyFilter, ImageToImageFilter);
...
private:
  EmptyFilter(const Self &) ITK_DELETE_FUNCTION;
