#ifndef LGSSMSUBJECT_H
#define LGSSMSUBJECT_H
//
//
//
#include <iostream>
...
namespace noVB
{
  namespace LGSSM
  {
    ...
    //
    template < int Dim, int Num_States >
      noVB::LGSSM::Subject< Dim, Num_States >::Subject( const std::string Pidn,
    ...
    template < int Dim, int Num_States > void
      noVB::LGSSM::Subject< Dim, Num_States >::add_tp( const int                  Age,
...
//	      }
    ...
    //
    template < int Dim, int Num_States > void
      noVB::LGSSM::Subject< Dim, Num_States >::write_solution()
      {
    ...
    //
    template < int Dim, int Num_States > void
      noVB::LGSSM::Subject< Dim, Num_States >::print() const
      {
