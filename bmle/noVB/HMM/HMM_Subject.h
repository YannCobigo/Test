...
namespace noVB
{
  namespace HMM
  {
    ...
    //
    template < int Dim, int Num_States >
      noVB::HMM::Subject< Dim, Num_States >::Subject( const std::string Pidn,
    ...
    template < int Dim, int Num_States > void
      noVB::HMM::Subject< Dim, Num_States >::add_tp( const int                  Age,
...
//	      }
    ...
    //
    template < int Dim, int Num_States > void
      noVB::HMM::Subject< Dim, Num_States >::write_solution()
      {
    ...
    //
    template < int Dim, int Num_States > void
      noVB::HMM::Subject< Dim, Num_States >::print() const
      {
