#ifndef NIPMAKEITKIMAGE_H
#define NIPMAKEITKIMAGE_H
//
//
//
#include <iostream>
...
namespace MAC_nip
{
  ...
  class NipMakeITKImage
    ...
    public:
      /** Constructor. */
      NipMakeITKImage():D_{0},image_name_{""}{};
      //
      explicit NipMakeITKImage( const long unsigned int ,
				 const std::string&,
				 const Reader3D::Pointer );
    
      /**  */
      virtual ~NipMakeITKImage(){};
