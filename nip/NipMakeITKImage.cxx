...
//
//
MAC_nip::NipMakeITKImage::NipMakeITKImage( const long unsigned int Dimension,
...
//
void
MAC_nip::NipMakeITKImage::set_val( const std::size_t Image_number, 
