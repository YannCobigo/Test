 ...
 *
 *=========================================================================*/
#ifndef itkBegLDDMM_h
#define itkBegLDDMM_h
...
private:
  ITK_DISALLOW_COPY_AND_ASSIGN(BegLDDMM);
